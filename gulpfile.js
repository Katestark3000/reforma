...
// Копирование ассетов
export const js = () =>
  gulp.src(paths.js.src, {encoding: false}).pipe(gulp.dest(paths.js.dest));
...
// Сборка
export const build = gulp.series(clean, gulp.parallel(styles, html, assets, js, imagesToWebp, imagesToMobileWebp));
